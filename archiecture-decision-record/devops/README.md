...
| ADR-DOP-00007  | System should capable to build binary from java application, create the docker image, push image to docker container registry, with help of CICD tool | 1.0.0       |
| ADR-DOP-00008  | System should capable to maintain the applications artifactories and central dependencies inside application network                                  | 1.0.0       |

## Dev Ops Service deployment in Kubernetes Cluster
![](https://paper-attachments.dropboxusercontent.com/s_2161CEC8E508F2CE54D7346FAD60D67DA570D3B8F3BF4177979F1EEE19417CE5_1725170474493_Kubernetes-DevOps.drawio.png)
